...
switch(typevehicule)
{
  case "Motos":
    ...
    {
      document.getElementById("Erreur").innerHTML = "Entry error try again";document.getElementById("res").innerHTML = "";
      break;
    }
  }
    case "Citadine" :
    ...
    default :  document.getElementById("Erreur").innerHTML = "Entry error try again";document.getElementById("res").innerHTML = "";
    }

if(total>0)
{
document.getElementById("Erreur").innerHTML = "";
document.getElementById("res").innerHTML = "Reservation passed successfully !! total :"+(Math.round(total * 100) / 100) +"$";
}
}
